...
def general_graph(data, option, min_mag, n_clusters, colorscale, location):
    ...
    if option == 'Scatter':
        ...
        size=sig, hover_name=time,
        color_continuous_scale=colorscale, size_max=10, zoom=0.6, opacity=0.6,
